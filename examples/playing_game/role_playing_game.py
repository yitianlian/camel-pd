...
def main(model_type=None) -> None:
    ...
    chat_log = {
        ...
        'dialogue': [{'user': user_response.msg.content, 'assistant': assistant_response.msg.content} for user_response, assistant_response in zip(user_responses, assistant_responses)],
